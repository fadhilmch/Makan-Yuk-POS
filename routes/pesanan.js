...
router.get('/',checkLogin, (req, res) => {
    models.Pesanan.findAll({
        ...
        .then(pesanans => {
            ...
            res.render('./pesanan/pesanan',{pesanans:pesanans.map(value => value.mejaId), user:req.session.user});
        })
});
        ...
        models.Menu.findAll({
            ...
            .then(menus => {
                res.render('./pesanan/pesanan-list', {
                   pesanan:pesanan,menus:menus,err:err, user:req.session.user
               });
            });
    })
});
...
router.get('/:id/meja/:no_meja/pesan/edit/:id_menu',checkLogin, (req,res) => {
    models.Pesanan.findById(req.params.id,{
        ...
        models.Menu.findAll({
            ...
            // res.send(menus);
            res.render('./pesanan/pesanan-edit', {id_menu:req.params.id_menu,menus:menus,pesanan:pesanan,user:req.session.user});
        })
    })
});
